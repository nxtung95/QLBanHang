 ...
 * @author ADMIN
 */
public class AddStaffManagerForm extends javax.swing.JFrame {

    private User user;
    private StaffManagerForm staffManagerForm;

    /**
     * Creates new form AddStaffManagerForm
     */
    public AddStaffManagerForm() {
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String nextStaffNo = userController.getNextStaffNo();
        jTextField1.setText(nextStaffNo);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        UserController userController = new UserController();
        boolean result = userController.add(staffNo, username, password, name, birthday, address, rank, storeId);
        if (result) {
            JOptionPane.showMessageDialog(rootPane, "Thêm nhân viên thành công");
            List<User> staffList = userController.getAllStaff(storeId, "");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddStaffManagerForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddStaffManagerForm().setVisible(true);
            }
        });
    }
    ...
    public void setData(StaffManagerForm staffManagerForm, User user) {
